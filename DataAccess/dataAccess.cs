    ...
    public class dataAccess
    {
        ...
        public static DataTable GetSimilarUser(string similiarame, SqlDataAdapter SqlAd)
        {
            ...
            if (similiarame != null && similiarame.Length >= 3)
            {
                ...
                string commandText = "select Username, Age, Province, Online, Blog, Album from Theuserinfo where Username like '%" + thenamestring + "%' or Username like '%" + thenamestring + "' or Username like '" + thenamestring + "%'";
                table = CreateTableByQuery(commandText, SqlAd);
            }
            return table;
        }
        ...
        {
            string commandText = "select Activate, Approve, Username from Theuserinfo where Username = '" + profilename + "'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select Username from Theuserinfo where Approve != 'Yes' and Activate='Yes'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select Approve from Theuserinfo where Username = '" + theprofile + "'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select Username, Age, Province from Theuserinfo where Gender = '" + gender + "' and Age >= " + minage + " and Age <= " + maxage + " and Activate = 'Yes' and Approve = 'Yes'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select Username, Age, Province from Theuserinfo where Age >= " + minage + " and Age <= " + maxage + " and Activate = 'Yes' and Approve = 'Yes'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select Username, Age, Province, Online, Blog, Album from Theuserinfo where Gender = '" + gender + "' and Age >= " + minage + " and Age <= " + maxage + " and Activate = 'Yes' and Approve = 'Yes'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select Username, Age, Province, Online, Blog, Album  from Theuserinfo where Age >= " + minage + " and Age <= " + maxage + " and Activate = 'Yes' and Approve = 'Yes'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select Username, Age, Province, Online, Blog, Album  from Theuserinfo where Age >= " + minage + " and Age <= " + maxage + " and Province = '" + province + "' and Gender = '" + gender + "' and Activate = 'Yes' and Approve = 'Yes'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select Username, Age, Province, Online, Album, Blog from Theuserinfo where Age >= " + minage + " and Age <= " + maxage + " and Gender = '" + gender + "' and Profilepic = '1' and Province = '" + province + "' and Activate = 'Yes' and Approve = 'Yes'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select Username, Age, Province, Online, Album, Blog from Theuserinfo where Age >= " + minage + " and Age <= " + maxage + " and Gender = '" + gender + "' and Profilepic = '1' and Activate = 'Yes' and Approve = 'Yes'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select Username, Age, Province, Online, Album, Blog from Theuserinfo where Age >= " + minage + " and Age <= " + maxage + " and Gender = '" + gender + "' and Album >= 1 and Province = '" + province + "' and Activate = 'Yes' and Approve = 'Yes'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select Username, Age, Province, Online, Album, Blog from Theuserinfo where Age >= " + minage + " and Age <= " + maxage + " and Gender = '" + gender + "' and Album >= 1 and Activate = 'Yes' and Approve = 'Yes'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select Username, Age, Province, Online, Album, Blog from Theuserinfo where Age >= " + minage + " and Age <= " + maxage + " and Gender = '" + gender + "' and Blog >= 1 and Province = '" + province + "' and Activate = 'Yes' and Approve = 'Yes'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select Username, Age, Province, Online, Album, Blog from Theuserinfo where Age >= " + minage + " and Age <= " + maxage + " and Gender = '" + gender + "' and Blog >= 1 and Activate = 'Yes' and Approve = 'Yes'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "update Theuserinfo set Age = '" + age + "', Province = '" + province + "', Gender = '" + gender + "', Profilepic = '" + profilepic + "', Activate = 'Yes' where Username = '" + username + "'";
        ...
        {
            string commandText = "update Theuserinfo set Age = '" + age + "', Province = '" + province + "', Gender = '" + gender + "', Profilepic = '" + profilepic + "', Activate = 'Yes', Approve = 'Yes' where Username = '" + username + "'";
            using (SqlConnection SqlConn1 = new SqlConnection(connectionString))
            {
                SqlCommand SqlComm;
                SqlConn1.Open();
        ...
        {
            string commandText = "update Theuserinfo set Online = '" + online + "' where Username = '" + username + "'";
            using (SqlConnection SqlConn1 = new SqlConnection(connectionString))
            {
                SqlCommand SqlComm;
                SqlConn1.Open();
        ...
        {
            string commandText = "update Theuserinfo set Blog = Blog + 1 where Username = '" + username + "'";
             using (SqlConnection SqlConn1 = new SqlConnection(connectionString))
            {
                SqlCommand SqlComm;
                SqlConn1.Open();
        ...
        {
            string commandText = "update Theuserinfo set Album = Album + 1 where Username = '" + username + "'";
             using (SqlConnection SqlConn1 = new SqlConnection(connectionString))
            {
                SqlCommand SqlComm;
                SqlConn1.Open();
        ...
        {
            string commandText = "update Theuserinfo set Activate = '" + activate + "' where Username = '" + username + "'";
            using (SqlConnection SqlConn1 = new SqlConnection(connectionString))
            {
                SqlCommand SqlComm;
                SqlConn1.Open();
        ...
        {
            string commandText = "update Theuserinfo set Approve = '" + approve + "' where Username = '" + username + "'";
            using (SqlConnection SqlConn1 = new SqlConnection(connectionString))
            {
                SqlCommand SqlComm;
                SqlConn1.Open();
        ...
        {
            string commandText = "select Username, Age, Province, Timestart from Theuserinfo where Gender = '" + gender + "' and Timestart > GETDATE() - 3 and Activate = 'Yes' and Approve = 'Yes' order by Timestart Desc";
        ...
        {
            string commandText = "select Username, Age, Province, Online, Blog, Album, Timestart from Theuserinfo where Gender = '" + gender + "' and Timestart > GETDATE() - 3 and Activate = 'Yes' and Approve = 'Yes' order by Timestart Desc";
        ...
        {
            string commandText = "select Username, Age, Province, Online, Blog, Album, Timestart from Theuserinfo where Age >= '" + minage + "' and Age <= '" + maxage + "' and Gender = '" + gender + "' and Timestart > GETDATE() - 7 and Activate = 'Yes' and Approve = 'Yes' order by Timestart Desc";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
        ...
        {
            string commandText = "select Username, Age, Province, Online, Blog, Album, Timestart from Theuserinfo where Age >= '" + minage + "' and Age <= '" + maxage + "' and Gender = '" + gender + "' and Timestart > GETDATE() - 30 and Activate = 'Yes' and Approve = 'Yes' order by Timestart Desc";
            DataTable table =  CreateTableByQuery(commandText, SqlAd);
        ...
        {
            string commandText = "select * from Historyinfo where Storytype = '" + type + "' and Historycategory = '" + category + "'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select * from Historyinfo where Storytype = '" + type + "' and Time like '%" + time + "'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select Id from Historyinfo where Time = GETDATE()";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            string commandText = "select Favoriteinfo.Favoritename, Theuserinfo.Age, Theuserinfo.Province, Theuserinfo.Online, Theuserinfo.Profilepic, Theuserinfo.Album, Theuserinfo.Blog from Favoriteinfo inner join Theuserinfo on Favoriteinfo.Favoritename = Theuserinfo.Username where Favoriteinfo.Username = '" + username + "' and Favoritetype = '" + favoritetype + "' order by Time desc";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
       ...
       /* public static DataTable GetByFavoriteNameType(string username, string favoritetype, SqlDataAdapter SqlAd)
        ...
        public static DataTable GetByFavoriteNameType(string username, string favoritetype, SqlDataAdapter SqlAd)
        {
            string commandText = "select Theuserinfo.Username, Age, Province, Online, Profilepic, Album, Blog from Theuserinfo inner join Favoriteinfo on Favoriteinfo.Username =  Theuserinfo.Username where Favoritename = '" + username + "' and Favoritetype = '" + favoritetype + "' order by Time desc";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        //my favorites
        ...
        {
            SqlDataAdapter SqlAd = new SqlDataAdapter();
            string commandText = "select count(*) from Visitorinfo";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
        ...
        {
            SqlDataAdapter SqlAd = new SqlDataAdapter();
            string commandText = "select Id from Visitorinfo where Favoritename = '" + username + "'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
        ...
        {
            SqlDataAdapter SqlAd = new SqlDataAdapter();
            string commandText = "insert into Visitorinfo (Id, Username, Favoritename, Time) values (" + id + ", '" + username + "', '" + favoritename + "', '" + time + "')";
            using (SqlConnection SqlConn1 = new SqlConnection(connectionString))
            {
                SqlCommand SqlComm;
                SqlConn1.Open();
        ...
        {
            SqlDataAdapter SqlAd = new SqlDataAdapter();
            string commandText = "select Theuserinfo.Username, Age, Province, Online, Profilepic, Album, Blog, Visitorinfo.Time from Theuserinfo inner join Visitorinfo on Theuserinfo.Username COLLATE DATABASE_DEFAULT = Visitorinfo.Username COLLATE DATABASE_DEFAULT where Visitorinfo.Favoritename COLLATE DATABASE_DEFAULT = '" + username + "' COLLATE DATABASE_DEFAULT and Theuserinfo.Activate COLLATE DATABASE_DEFAULT = 'Yes' COLLATE DATABASE_DEFAULT and Theuserinfo.Approve COLLATE DATABASE_DEFAULT = 'Yes' COLLATE DATABASE_DEFAULT order by Time desc";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
        ...
        public static void UpdateVisitorByUser(string Username, string Favoritename)
        {
            ...
            string commandText = "update Visitorinfo set Time = '" + DateTime.Now.ToString() + "' where Username = '" + Username + "' and Favoritename = '" + Favoritename + "'";
            using (SqlConnection SqlConn1 = new SqlConnection(connectionString))
            {
                SqlCommand SqlComm;
                SqlConn1.Open();
        ...
        {
            string commandText = "select Theuserinfo.Username, Age, Province, Online, Profilepic, Album, Blog, Favoriteinfo.Time from Theuserinfo inner join Favoriteinfo on Theuserinfo.Username COLLATE DATABASE_DEFAULT = Favoriteinfo.Username COLLATE DATABASE_DEFAULT where Favoriteinfo COLLATE DATABASE_DEFAULT = '" + username + "' COLLATE DATABASE_DEFAULT and Favoritetype COLLATE DATABASE_DEFAULT = 'visitors' COLLATE DATABASE_DEFAULT and  Theuserinfo.Activate COLLATE DATABASE_DEFAULT = 'Yes' COLLATE DATABASE_DEFAULT and Theuserinfo.Approve COLLATE DATABASE_DEFAULT = 'Yes' COLLATE DATABASE_DEFAULT order by Time desc";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
            return table;
        }
        ...
        {
            SqlDataAdapter SqlAd = new SqlDataAdapter();
            string commandText = "select count(*) from Keyinfo";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
        ...
        {
            SqlDataAdapter SqlAd = new SqlDataAdapter();
            string commandText = "insert into Keyinfo (Id, Username, Favoritename, Keystatus) values (" + id + ", '" + username + "', '" + favoritename + "', '" + keystatus + "')";
            using (SqlConnection SqlConn1 = new SqlConnection(connectionString))
            {
                SqlCommand SqlComm;
                SqlConn1.Open();
        ...
        {
            SqlDataAdapter SqlAd = new SqlDataAdapter();
            string commandText = "select Id from Keyinfo where Username = '" + favoritename + "' and Favoritename = '" + username + "' and Keystatus = 'albumkey'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
        ...
        {
            SqlDataAdapter SqlAd = new SqlDataAdapter();
            string commandText = "select Theuserinfo.Username, Age, Province, Online, Profilepic, Album, Blog, Keyinfo.Key from Theuserinfo inner join Keyinfo on Theuserinfo.Username COLLATE DATABASE_DEFAULT = Keyinfo.Username COLLATE DATABASE_DEFAULT where Keyinfo.Favoritename COLLATE DATABASE_DEFAULT = '" + username + "'";
            DataTable table = CreateTableByQuery(commandText, SqlAd);
        ...
        public static void UpdateKeyByUser(string key, string Username, string Favoritename)
        {
            SqlDataAdapter SqlAd = new SqlDataAdapter();
            DataTable table = new DataTable();
            string commandText = "update Keyinfo set Keystatus = '" + key + "' where Username = '" + Username + "' and Favoritename = '" + Favoritename + "'";
            using (SqlConnection SqlConn1 = new SqlConnection(connectionString))
            {
                SqlCommand SqlComm;
                SqlConn1.Open();
        ...
        {
            string commandText = "select * from Theuserinfo where Timestart > GETDATE() - 30 and Activate = 'Yes' and Approve = 'Yes' order by Timestart desc";
        ...
        {
            string commandText = "select * from Theuserinfo where Timestart > GETDATE() - 30 and Activate = 'Yes' and Approve = 'Yes' order by Time desc";
