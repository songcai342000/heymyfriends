<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/Hjemside.master" CodeFile="Profilepage.aspx.cs" Inherits="Profilepage" %>
        ...
        <div>
            ...
            <div><asp:LinkButton runat="server" id="favoritt" Text="Mine favoritt profiler" 
             ...
             <br/>             
                    ...
                    <td style="width:76%; padding-top:10px; padding-right:10px; padding-left:10px;" valign="top" >
