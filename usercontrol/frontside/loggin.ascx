<%@ Control EnableViewState="false" Language="C#" AutoEventWireup="true" CodeFile="loggin.ascx.cs" Inherits="usercontrol_frontside_loggin" %>

 <table style="width:950px;background-color:#ffddff;" align="center">
	                <tr>
                <!-- start left -->
			                <td style="width:40%;height:150px; padding-left:10px">
			                <br/>
