<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" MasterPageFile="~/Master/Hjemside.master" Inherits="administrator_Default" %>
...
<%@ Register src="../usercontrol/minside/administrationvenstercategory.ascx" tagname="administrationvenstercategory" tagprefix="uc5" %>
<%@ Register src="../usercontrol/minside/administration.ascx" tagname="administration" tagprefix="uc7" %>
    ...
    <tr>
        <td>
            <table style="font-size:small">
                <tr>
                    <td style="width:24%; padding-left:10px; padding-top:10px" valign="top">
<table id="lefttables"> 
<tr>
<td>
     <div>
        ...
        <div>
            ...
            <div><asp:LinkButton runat="server" id="favoritt" Text="Mine favoritt profiler" 
             ...
             <br/>             
                    ...
                    <td style="width:76%; padding-top:10px; padding-left:10px; padding-right:10px;" align="left" valign="top">
                        <uc7:administration ID="administration1" runat="server" />
                    </td>
                </tr>
            </table>
        </td>
